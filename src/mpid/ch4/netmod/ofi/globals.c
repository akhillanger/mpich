...
MPIDI_OFI_COLL_MPICH_KARY_global_t          MPIDI_OFI_COLL_MPICH_KARY_global;
MPIDI_OFI_COLL_MPICH_KNOMIAL_global_t       MPIDI_OFI_COLL_MPICH_KNOMIAL_global;
MPIDI_OFI_COLL_MPICH_DISSEM_global_t      MPIDI_OFI_COLL_MPICH_DISSEM_global;

MPIDI_OFI_COLL_TRIGGERED_KARY_global_t     MPIDI_OFI_COLL_TRIGGERED_KARY_global;
MPIDI_OFI_COLL_TRIGGERED_KNOMIAL_global_t  MPIDI_OFI_COLL_TRIGGERED_KNOMIAL_global;
MPIDI_OFI_COLL_TRIGGERED_DISSEM_global_t MPIDI_OFI_COLL_TRIGGERED_DISSEM_global;

MPIDI_OFI_COLL_STUB_KARY_global_t      MPIDI_OFI_COLL_STUB_KARY_global;
MPIDI_OFI_COLL_STUB_KNOMIAL_global_t   MPIDI_OFI_COLL_STUB_KNOMIAL_global;
...
MPIDI_OFI_COLL_MPICH_OP_TABLE(KARY);
MPIDI_OFI_COLL_MPICH_OP_TABLE(KNOMIAL);
MPIDI_OFI_COLL_MPICH_OP_TABLE(DISSEM);
MPIDI_OFI_COLL_MPICH_OP_TABLE(RECEXCH);

MPIDI_OFI_COLL_TRIGGERED_OP_TABLE(KARY);
MPIDI_OFI_COLL_TRIGGERED_OP_TABLE(KNOMIAL);
MPIDI_OFI_COLL_TRIGGERED_OP_TABLE(DISSEM);
MPIDI_OFI_COLL_TRIGGERED_OP_TABLE(RECEXCH);

MPIDI_OFI_COLL_MPICH_OP_TABLE(STUB);

MPIDI_OFI_COLL_STUB_OP_TABLE(KARY);
MPIDI_OFI_COLL_STUB_OP_TABLE(KNOMIAL);
