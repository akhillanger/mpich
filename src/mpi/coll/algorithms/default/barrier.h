...
#ifndef MPIC_DEFAULT_BARRIER_H
#define MPIC_DEFAULT_BARRIER_H
...
MPIC_INLINE int barrier_smp_intra(MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag)
{
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Barrier_recursive_doubling(MPIR_Comm *comm_ptr, MPIR_Errflag_t *errflag)
{
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Barrier_intra(MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag)
{
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Barrier_inter(MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag)
{
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Barrier(MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag)
{
    int mpi_errno = MPI_SUCCESS;
