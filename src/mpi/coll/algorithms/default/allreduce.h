...
#ifndef MPIC_DEFAULT_ALLREDUCE_H
#define MPIC_DEFAULT_ALLREDUCE_H
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Allreduce_recursive_doubling(
    const void *sendbuf,
    void *recvbuf,
    int count,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Allreduce_reduce_scatter_allgather(
    const void *sendbuf,
    void *recvbuf,
    int count,
    MPI_Datatype datatype,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Allreduce_intra ( 
    const void *sendbuf,
    void *recvbuf, 
    int count, 
    MPI_Datatype datatype, 
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Allreduce_inter(const void *sendbuf,
                                             void *recvbuf,
                                             int count,
                                             MPI_Datatype datatype,
                                             MPI_Op op,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Allreduce(const void *sendbuf, void *recvbuf, int count,
