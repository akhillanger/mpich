...
MPIC_INLINE int COLL_comm_init(COLL_comm_t * comm, int *tag, int rank, int size)
{
    comm->curTag = tag;
...
MPIC_INLINE int COLL_bcast_get_ring_schedule(void *buffer, int count, COLL_dt_t datatype,
