...
#undef FUNCNAME
#define FUNCNAME COLL_kick_sched
/* Routing to kick-start and completely execute a blocking schedule*/
MPIC_INLINE void COLL_kick_sched(TSP_sched_t * sched)
{
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_COLL_KICK_SCHED);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_COLL_KICK_SCHED);
    ...
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_COLL_KICK_SCHED);
}

#undef FUNCNAME
#define FUNCNAME COLL_kick_nb
/* Function to make progress on a non-blocking collective*/
MPIC_INLINE int COLL_kick_nb(MPIC_queue_elem_t * elem)
{
...
#undef FUNCNAME
#define FUNCNAME COLL_kick_sched_nb
/* Routing to kick-start a non-blocking schedule*/
MPIC_INLINE int COLL_kick_sched_nb(TSP_sched_t * sched, COLL_req_t * request)
{
    int rc;

    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_COLL_KICK_SCHED_NB);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_COLL_KICK_SCHED_NB);
    ...
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_COLL_KICK_SCHED_NB);
