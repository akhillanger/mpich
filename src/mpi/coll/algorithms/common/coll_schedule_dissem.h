                           ...
                           COLL_comm_t * comm, int tag, TSP_sched_t * s, int k, bool buffer_per_phase)
{
    ...
    MPIC_DBG("send_type_size: %d, send_type_extent: %d, send_count: %d\n", s_type_size, s_extent, sendcount);
    ...
    MPIC_DBG("Step 2 scheduled\n");
    MPIC_DBG("Step 2: num_unpacks_in_last_phase: %d\n", num_unpacks_in_last_phase);
...
MPIC_INLINE int COLL_sched_barrier_dissem(int tag, COLL_comm_t * comm, TSP_sched_t * s)
{
