...
MPIC_INLINE int COLL_barrier(COLL_comm_t * comm, int *errflag)
{
    int rc = 0;
...
MPIC_INLINE int COLL_ibarrier(COLL_comm_t * comm, COLL_req_t * request)
{
    int rc = 0;
    COLL_args_t coll_args = {.nargs = 1,
        .args = {.barrier = {.k = 0}}
...
MPIC_INLINE int COLL_alltoall(const void *sendbuf,
                              int sendcount,
                              COLL_dt_t sendtype,
                              void *recvbuf,
                              int recvcount,
...
MPIC_INLINE int COLL_ialltoall(const void *sendbuf,
                               int sendcount,
                               COLL_dt_t sendtype,
                               void *recvbuf,
                               int recvcount,
...
MPIC_INLINE int COLL_iallreduce(const void *sendbuf,
                                void *recvbuf,
                                int count,
                                COLL_dt_t datatype,
