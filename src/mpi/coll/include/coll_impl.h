...
/*Default Algorithms*/
#include "../algorithms/default/post.h"
...
MPIC_INLINE int MPIC_progress_hook()
{
    int count = 0;
...
MPIC_INLINE int MPIC_comm_init(struct MPIR_Comm *comm)
{
...
MPIC_INLINE int MPIC_comm_cleanup(struct MPIR_Comm *comm)
{
    int mpi_errno = MPI_SUCCESS;
