...
#define COLL_kick_sched                 COLL_NAMESPACE(kick_sched)
#define COLL_kick_sched_nb              COLL_NAMESPACE(kick_sched_nb)
...
#define COLL_sched_bcast_ring           COLL_NAMESPACE(sched_bcast_ring)
#define COLL_bcast_get_ring_schedule    COLL_NAMESPACE(bcast_get_ring_schedule)
#define COLL_sched_bcast_ring_pipelined COLL_NAMESPACE(sched_bcast_ring_pipelined)
