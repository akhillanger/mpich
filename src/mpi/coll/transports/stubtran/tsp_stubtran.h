...
#define MPIR_TSP_sched_vtcs_completion      MPII_Stubutil_sched_vtcs_completion
...
int MPII_Stubutil_sched_vtcs_completion(MPII_Stubutil_sched_t * sched, int n_in_vtcs, int *invtcs);
