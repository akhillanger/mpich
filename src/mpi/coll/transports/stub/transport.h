...
static inline int MPIC_STUB_addref_dt_nb(MPIC_STUB_dt_t dt,
                                         int up, MPIC_STUB_sched_t * sched, int n_invtcs,
                                         int *invtcs)
{
    return 0;
}
...
static inline int MPIC_STUB_reduce_local(const void *inbuf,
                                         ...
                                         MPIC_STUB_sched_t * sched, int nvtcs, int *vtcs)
{
    return 0;
}
...
static inline int MPIC_STUB_dtcopy_nb(void *tobuf,
                                      ...
                                      const void *frombuf,
                                      int fromcount,
                                      MPIC_STUB_dt_t fromtype, MPIC_STUB_sched_t * sched,
                                      int n_invtcs, int *invtcs)
{
    return 0;
}
...
static inline int MPIC_STUB_free_mem_nb(void *ptr, MPIC_STUB_sched_t * sched, int n_invtcs,
                                        int *invtcs)
{
    return 0;
}
